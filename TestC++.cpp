...
int main()
{
    /*
        ...
        Для оценки моих компетенций Прошу Вас ознакомиться с демонстрационными проектами : https://github.com/0aaa
        В том числе с моим Pet-проектом Медицинской Информационной Системы : https://github.com/0aaa/thss0
    */
